...
/**
 * Thrown when a redirect symbol is not found in command arguments by
 * CommandRedirectSplitter.
 * 
 * @author liangho
 */
public class RedirectSymbolNotPresentException extends Exception {

  /**
   * Generated serial number.
   */
  private static final long serialVersionUID = 8636394288128155901L;
